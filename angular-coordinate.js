...
angular.module('angular-coordinate', ['angular-coordinate.html']).directive('coordinate', function () {
  return {
    restrict: 'E',
    templateUrl: 'angular-coordinate.html',
    link: function (scope, element, attrs) {
      var canvasElement, width, height, ctx, centerPoint, isDragging, scaleX, scaleY, dragPoint, mouseTrackerElements, showInput, points = [], functions = [];
      ...
      function initScrollListener() {
        canvasElement.addEventListener('mousewheel', function (e) {
          var ratio = scaleX / scaleY, minimumScale = 1.05, newScaleX = scaleX + e.wheelDelta * 0.05 * ratio, newScaleY = scaleY + e.wheelDelta * 0.05;
      ...
      function drag(e) {
        var diffX = e.offsetX - dragPoint[0], diffY = e.offsetY - dragPoint[1];
        centerPoint[0] += diffX;
        centerPoint[1] += diffY;
        draw();
      }
      ...
      function drawXAxis() {
        ...
        var numberOfTicks = width / scaleX, currentTick, miniTick, product;
      ...
      function drawYAxis() {
        ...
        var numberOfTicks = height / scaleY, currentTick, miniTick, product;
        for (currentTick = 1; currentTick <= numberOfTicks; currentTick++) {
